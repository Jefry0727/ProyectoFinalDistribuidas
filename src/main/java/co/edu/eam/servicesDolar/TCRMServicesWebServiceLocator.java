...
public class TCRMServicesWebServiceLocator extends org.apache.axis.client.Service implements TCRMServicesWebService
{
	...
	{
            TCRMServicesWebServiceSoapBindingStub _stub = null;
            try {
                _stub = new TCRMServicesWebServiceSoapBindingStub(portAddress, this);
            } catch (AxisFault ex) {
                Logger.getLogger(TCRMServicesWebServiceLocator.class.getName()).log(Level.SEVERE, null, ex);
            }
